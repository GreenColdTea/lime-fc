 ...
 *
 * Commandline:
 *    --api='gl:compatibility=4.6' --extensions='GL_APPLE_vertex_array_object,GL_ARB_draw_instanced,GL_ARB_instanced_arrays,GL_ARB_vertex_array_object,GL_EXT_draw_instanced,GL_EXT_framebuffer_blit,GL_EXT_framebuffer_multisample,GL_EXT_framebuffer_object,GL_KHR_blend_equation_advanced,GL_KHR_blend_equation_advanced_coherent' c
 *
 * Online:
 *    http://glad.sh/#api=gl%3Acompatibility%3D4.6&extensions=GL_APPLE_vertex_array_object%2CGL_ARB_draw_instanced%2CGL_ARB_instanced_arrays%2CGL_ARB_vertex_array_object%2CGL_EXT_draw_instanced%2CGL_EXT_framebuffer_blit%2CGL_EXT_framebuffer_multisample%2CGL_EXT_framebuffer_object%2CGL_KHR_blend_equation_advanced%2CGL_KHR_blend_equation_advanced_coherent&generator=c&options=
 *
 */
