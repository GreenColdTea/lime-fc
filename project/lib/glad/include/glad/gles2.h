 ...
 *
 * Commandline:
 *    --api='gles2=3.2' --extensions='GL_EXT_draw_instanced,GL_KHR_blend_equation_advanced,GL_KHR_blend_equation_advanced_coherent' c
 *
 * Online:
 *    http://glad.sh/#api=gles2%3D3.2&extensions=GL_EXT_draw_instanced%2CGL_KHR_blend_equation_advanced%2CGL_KHR_blend_equation_advanced_coherent&generator=c&options=
 *
 */
