...
class AssetHelper
{
	...
	{
		knownExtensions = [
			"jpg" => IMAGE, "jpeg" => IMAGE, "png" => IMAGE, "gif" => IMAGE, "webp" => IMAGE, "bmp" => IMAGE, "tiff" => IMAGE, "jfif" => IMAGE,
			"tga" => IMAGE, "avif" => IMAGE, "tif" => IMAGE, "jxl" => IMAGE, "pcx" => IMAGE, "xcf" => IMAGE, "xpm" => IMAGE, "qoi" => IMAGE, 
			"lbm" => IMAGE, "iff" => IMAGE, "pnm" => IMAGE, "ppm" => IMAGE, "pgm" => IMAGE, "pbm" => IMAGE,

			"otf" => FONT, "ttf" => FONT, 
			
			"wav" => SOUND, "wave" => SOUND, "flac" => SOUND, "opus" => SOUND, "mid" => SOUND, "midi" => SOUND, "ogg" => SOUND, "spx" => SOUND, 
			"au" => SOUND, "aiff" => SOUND, "oga" => SOUND, 
			
			"mp3" => MUSIC, "mp2" => MUSIC, 
			
			"exe" => BINARY, "bin" => BINARY, "so" => BINARY, "pch" => BINARY, "dll" => BINARY, "zip" => BINARY, "tar" => BINARY, "gz" => BINARY, 
			"fla" => BINARY, "swf" => BINARY, "atf" => BINARY, "psd" => BINARY, "awd" => BINARY, 
			
			"txt" => TEXT, "text" => TEXT, "xml" => TEXT, "java" => TEXT, "hx" => TEXT, "cpp" => TEXT, "c" => TEXT, "h" => TEXT, "cs" => TEXT, 
			"js" => TEXT, "mm" => TEXT, "hxml" => TEXT, "html" => TEXT, "json" => TEXT, "css" => TEXT, "gpe" => TEXT, "pbxproj" => TEXT, 
