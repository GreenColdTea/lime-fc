...
class NativeCFFI
{
	...
	private static var lime_vorbis_file_crosslap = new cpp.Callable<cpp.Object->cpp.Object->Int>(cpp.Prime._loadPrime("lime", "lime_vorbis_file_crosslap", "ooi", false));
	...
	private static var lime_vorbis_file_pcm_seek = new cpp.Callable<cpp.Object->Int->Int->Int>(cpp.Prime._loadPrime("lime", "lime_vorbis_file_pcm_seek", "oiii", false));
	private static var lime_vorbis_file_pcm_seek_lap = new cpp.Callable<cpp.Object->Int->Int->Int>(cpp.Prime._loadPrime("lime", "lime_vorbis_file_pcm_seek_lap", "oiii", false));
	private static var lime_vorbis_file_pcm_seek_page = new cpp.Callable<cpp.Object->Int->Int->Int>(cpp.Prime._loadPrime("lime", "lime_vorbis_file_pcm_seek_page", "oiii", false));
	private static var lime_vorbis_file_pcm_seek_page_lap = new cpp.Callable<cpp.Object->Int->Int->Int>(cpp.Prime._loadPrime("lime", "lime_vorbis_file_pcm_seek_page_lap", "oiii", false));
	private static var lime_vorbis_file_raw_seek = new cpp.Callable<cpp.Object->Int->Int->Int>(cpp.Prime._loadPrime("lime", "lime_vorbis_file_raw_seek", "oiii", false));
	private static var lime_vorbis_file_raw_seek_lap = new cpp.Callable<cpp.Object->Int->Int->Int>(cpp.Prime._loadPrime("lime", "lime_vorbis_file_raw_seek_lap", "oiii", false));
